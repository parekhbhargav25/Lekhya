// // app/components/ChatbotWidget.tsx (or wherever you keep it)
// "use client";
...
//             </button>
//           </div>
//           {/* Optional fake mic button to match design */}
//           <div className="mt-2 flex justify-center">
//             <button
//               type="button"
//               className="h-8 w-8 flex items-center justify-center rounded-full bg-[#ede7ff] text-[#8468ff] text-lg"
